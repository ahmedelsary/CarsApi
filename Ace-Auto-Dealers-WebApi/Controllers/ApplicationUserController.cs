    ...
    public class ApplicationUserController : ControllerBase
    {
        ...
        public async Task<Object> PostApplicationUser(ApplicationUserModel model)
        {
            ...
            try
            {
                ...
                await _userManager.AddClaimAsync(user, new Claim(ClaimTypes.Role, model.Role==0? "Adminstrator": "SalesRepresentative"));
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        [Authorize]
        [HttpGet("UserClaims")]
        //POST : /api/ApplicationUser/UserClaims
        public async Task<object> GetUserClaim()
        {
            ...
            return new
            {
                ...
                user.Email,
                user.UserName,
                userClaims = claims.Select(a => new { type = a.Type, value = a.Value })
            };
